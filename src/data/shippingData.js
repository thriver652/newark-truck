import { FreeShipIcon, EasyReturnIcon } from "../images";
...
export const shippingData = [
  {
    ...
    policyLink: "/shipping-policy",
    icon: FreeShipIcon, // Add icon for free shipping
  },
  {
    title: "Easy Returns",
    ...
    icon: EasyReturnIcon, // Add icon for easy returns
  },
];
